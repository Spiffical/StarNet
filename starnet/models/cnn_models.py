...
from starnet.models.base_cnn import BaseModel
...
from starnet.models.base_cnn import ModelMGPU
...
class StarNet2017DeepEnsemble(StarNet2017):
    ...
    def compile_model(self):
        ...
        if self.num_gpu > 1:
            ...
            self.mgpu_keras_model.compile(loss=self.loss_func(sigma), optimizer=self.optimizer, metrics=self.metrics,
                                          loss_weights=None)
        else:
